...
class College():
    ...
    def get_all(self, page_num: int = None, item_per_page: int = None, paginate: bool = True) -> list:
        ...
        query = f'''
            SELECT college.code, college.name, COUNT(course.code) AS courses, IFNULL(enrolled.student, 0) AS enrolled
            FROM college
            JOIN course 
            ...
            GROUP BY college.code, college.name, enrolled.student
            LIMIT 
